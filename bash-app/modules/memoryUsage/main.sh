...
while IFS= read -r line; do
  if [[ $line == *"Mem:"* ]]; then
    ...
    used_percentage=$((100 * ${used%G} / ${total%G}))
  fi
...
# Calculate global score based on usage percentage
...
log_info "memory_usage: finished memory usage check with score $SCORE/5"
